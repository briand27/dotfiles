;; From "Writing GNU Emacs Extensions" - unfinished
...
(defun current-line ()
  ...
  (let ((result 1))                ;Emacs counts lines starting from 1.
    (save-excursion
...
; note `substitute-key-definition` uses the user's preferred bindings
(let ((equivs
